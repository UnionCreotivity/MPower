  ...
  <div class="method-content-box swcm">
    ...
    <div class="right-box">
      ...
      <div class="content-box">
        <div class="content">
          牆雖屬次結構，但也是建築防震之第二道重要防線。牆體鋼筋間距、厚度需定位綁紮，才能發揮牆體的抗剪力效果。「Alfa
          Safe系統牆」鋼筋的規劃設計與施工，於牆體端部與轉角處，皆採用一體式牆箍專利結構工法，使牆筋綁紮更加確實堅固、鋼筋間距整齊一致、保護層厚度足夠，確保牆體達到防裂、防水且抗剪力更佳，總體提升房屋的結構安全與抗震力。
        </div>
      </div>
      <div class="arrow-box">
